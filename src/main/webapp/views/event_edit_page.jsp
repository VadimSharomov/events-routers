...
<div class="container">
    ...
    <form role="form" class="form-horizontal" action="/event/edit" method="post">
        <input class="form-control form-group" type="text" name="name" placeholder="Event name"
               value="${event.name}">
        <input class="form-control form-group" type="text" name="location" placeholder="Location"
               value="${event.location}">
        <input class="form-control form-group" type="date" name="dateFrom" placeholder="Date from" value="${dateFrom}">
